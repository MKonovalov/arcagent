//! **arcagent** — the agent runtime for Rust.
//!
...
//!
//! ```no_run
//! use arcagent::{Agent, provider::ModelConfig, tools};
//!
//! # #[tokio::main]
//! # async fn main() {
...
//!   [OpenAPI specs](https://docs.rs/arcagent/latest/arcagent/openapi/index.html)
...
//!   policy engines (arcagent ships no policy — you install it).
...
//!
//! The [book](https://MKonovalov.github.io/arcagent/) covers concepts and
